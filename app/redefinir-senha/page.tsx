...
function RedefinirSenhaConteudo() {
  ...
  async function handleSubmit(
    ...
    try {
      ...
      console.error(
        "[usuario/redefinir-senha] falha na requisição:",
        erroRequisicao,
      );
      ...
      <main className="min-h-screen flex items-center justify-center bg-[#020617] text-white px-6">
        <div className="bg-slate-900 p-8 rounded-xl border border-white/10 w-full max-w-md space-y-5 text-center">
          ...
          <p className="text-sm text-slate-400">
            Por segurança, faça login novamente utilizando
            a nova senha.
          </p>
    ...
    <main className="min-h-screen flex items-center justify-center bg-[#020617] text-white px-6">
      ...
      >
        ...
        {!token && (
          <div
            role="alert"
            className="bg-red-500/10 border border-red-500/30 text-red-400 px-4 py-3 rounded-lg text-sm text-center"
          >

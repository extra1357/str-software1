...
export default function RecuperarSenhaUsuarioPage() {
  ...
  async function handleSubmit(evento: React.FormEvent) {
    ...
    try {
      ...
      if (!resposta.ok) {
        setErro(
          dados.erro || "Não foi possível processar a solicitação.",
        );
        return;
      }
      ...
      console.error(
        "[usuario/recuperar-senha] falha na requisição:",
        erroRequisicao,
      );
    ...
    <main className="min-h-screen flex items-center justify-center bg-[#020617] text-white px-6">
      ...
      >
        ...
        <p className="text-sm text-slate-400 text-center">
          Informe o e-mail da sua conta interna STR.
        </p>
